...
document.localization["ru_RU"] = {
  ...
  "signup.email.used":
    "Клиент с таким адресом электронной почты уже зарегистрирован",
  "signup.name.used": "Клиент с таким именем пользователя уже зарегистрирован",
  "signup.complete": "Спасибо за регистрацию!",
  "signup.email.check":
    "Пожалуйста, проверьте свою электронную почту и перейдите по ссылке, чтобы завершить регистрацию!",
  ...
  "signup.customer.id.invalid":
    "Используйте 6 или более символов, только буквы и цифры",
  ...
  "signup.finalized.description":
    "В ближайшее время вы должны получить электронное письмо с полезными инструкциями. Пожалуйста, просмотрите это письмо и войдите в веб-панель, используя свое имя пользователя и пароль.",
  "signup.token.invalid.title": "Токен недействителен или уже используется",
  "signup.token.invalid.description":
    "Пожалуйста, повторите попытку регистрации, чтобы создать новую учетную запись!",
  ...
  "devices.permissions.not.as.device.admin":
    "- Приложение не установлено как администратор устройства",
  "devices.permissions.window.overlap.prohibited":
    "- Наложение поверх других окон недоступно",
  "devices.permissions.history.access.prohibited":
    "- Доступ к истории использования не настроен",
  ...
  "devices.app.installed.and.version.available":
    "- ${applicationName}: установл. ${applicationInstalledVersion}, доступна ${applicationVersionAvailable}",
  "devices.app.needs.removal": "${applicationVersion}, требуется удаление",
  "devices.no.data": "Устройство не передало данных",
  "devices.settings.conformance.broken":
    "Несоответствие настройкам: (${serverData})",
  "devices.file.installed": "- ${file}: установл.",
  "devices.file.not.installed": "- ${file}: не установл.",
  "devices.file.lastUpdate.differs":
    "- ${file}: различие во врмени модификации ${diff} мин",
  ...
  "question.impersonate.user":
    'Войти в приложение от имени администратора организации "${customerName}"?',
  "question.change.user":
    'Войти в приложение от имени пользователя "${userName}"?',
  ...
  "question.delete.application.version":
    'Удалить версию "${applicationVersion}"?',
  "question.delete.configuration":
    'Удалить конфигурацию "${configurationName}"?',
  ...
  "question.exit.without.saving":
    "Изменения не сохранены. Всё равно покинуть эту страницу?",
  "question.turn2common.application":
    'Сделать общим приложение "${applicationName}"?',
  "question.app.upgrade":
    'Обновить приложение "${v1}" до последней версии для конфигурации "${v2}"?',
  ...
  "error.application.version.pkg.mismatch":
    "ID пакета файла (${actual}) не соответствует приложению (${expected})",
  ...
  "error.invalid.character":
    "Номер устройства не может содержать символы / ? &",
  "error.invalid.configuration.mainApp":
    "В настройках MDM используется неверное главное приложение",
  "error.invalid.configuration.contentApp":
    "В настройках MDM используется неверное контентное приложение",
  ...
  "error.empty.customer.device.configuration":
    "Выберите конфигурацию устройств",
  "error.empty.customer.duplicate.prefix": "Префикс уже используется",
  "error.duplicate.customer.name":
    "Организация с введенным именем уже существует. Попробуйте другое имя.",
  "error.duplicate.group.name":
    "Группа с введенным именем уже существует. Попробуйте другое имя.",
  "error.duplicate.configuration.name":
    "Конфигурация с введенным именем уже существует. Попробуйте другое имя.",
  ...
  "error.configuration.device.use":
    'Невозможно удалить эту конфигурацию, она используется на устройствах. Сначала перейдите в "Устройства", найдите устройства, использующие эту конфигурацию, и измените их настройки.',
  ...
  "error.duplicate.application":
    "Приложение c таким ID пакета и версией уже существует",
  "error.recent.application.version.exists":
    "Существует более поздняя версия приложения",
  "error.common.application.access.prohibited":
    "Управлять общим приложением может только Супер-Администратор",
  "error.application.config.reference.exists":
    "Приложение используется в конфигурациях и не может быть удалено",
  "error.application.version.deletion.prohibited":
    "Версия либо явялется единственной, либо используется в конфигурациях и не может быть удалена",
  ...
  "error.notempty.group":
    "В данную группу входят одно или несколько устройств. Вы не можете её удалить.",
  ...
  "error.app.name.exists":
    "Приложение с таким названием уже есть. Укажите уникальное имя.",
  ...
  "success.file.uploaded.need.save":
    'Файл успешно загружен. Введите относительный путь и нажмите кнопку "Сохранить".',
  ...
  "success.config.update.notification":
    "Команда обновления конфигурации отправлена на устройства",
  "success.config.update.device.app.settings.notification":
    "Команда обновления настроек приложений отправлена на устройство",

  "form.icon.title": "Иконка",
  "form.icon.name": "Название",
  "form.icon.file": "Файл",

  "configuration.add.warning":
    "Вы уверены, что хотите создать пустую конфигурацию? Вам нужно будет добавить все необходимые системные приложения вручную. Рекомендуем скопировать и существующую конфигурацию и модифицировать копию.",
  "configuration.remove.warning":
    "Вы уверены, что хотите удалить последнюю конфигурацию? Вы потеряете информацию о том, какие системные приложения требуются.",
  ...
  "form.configuration.settings.system.schedule.app.update":
    "Обновление приложений по распис-ю",
  ...
  "form.configuration.settings.download.updates.limited":
    "3 попытки в мобильной сети",
  ...
  "form.configuration.settings.block.status.bar.hint":
    "Этот параметр устарел и работает только на Android 6 и ниже. Чтобы заблокировать строку состояния в новых версиях Android, используйте режим киоска (настройки MDM).",
  "form.configuration.settings.mdm.kiosk.mode": "Режим киоска",
  "form.configuration.settings.mdm.app.main": "MDM приложение",
  "form.configuration.settings.mdm.component.event.receiver":
    "Класс - администратор",
  "form.configuration.settings.mdm.component.event.receiver.placeholder":
    "Должен быть com.hmdm.launcher.AdminReceiver",
  "form.configuration.settings.mdm.component.wifi.ssid": "WiFi SSID",
  "form.configuration.settings.mdm.component.wifi.ssid.placeholder":
    "WiFi SSID - оставьте пустым для ручного ввода",
  "form.configuration.settings.mdm.component.wifi.password": "WiFi пароль",
  "form.configuration.settings.mdm.component.wifi.password.placeholder":
    "WiFi пароль - оставьте пустым для ручного ввода",
  "form.configuration.settings.mdm.component.wifi.security": "Тип защиты WiFi",
  "form.configuration.settings.mdm.component.wifi.notice":
    "Внимание: настройки WiFi применяются только для начальной регистрации устройства!",
  "form.configuration.settings.mdm.component.server.url": "URL нового сервера",
  "form.configuration.settings.mdm.component.server.url.placeholder":
    "Заполняется при миграции на новый MDM сервер",
  ...
  "form.configuration.settings.mdm.kiosk.notifications":
    "Разрешить уведомления",
  "form.configuration.settings.mdm.kiosk.system.info":
    "Разрешить информацию в статус-баре",
  "form.configuration.settings.mdm.kiosk.keyguard":
    "Разрешить блокировку экрана",
  "form.configuration.settings.mdm.kiosk.lock.buttons":
    "Блокировка кнопки питания",
  "form.configuration.settings.mdm.mobile.enrollment":
    "Настраивать через мобильную сеть",
  "form.configuration.settings.mdm.encrypt.device":
    "Зашифровать хранилище устройства",
  "form.configuration.settings.mdm.lock.safe.settings":
    "Блокировать безопасные настройки",
  ...
  "form.configuration.settings.mdm.allowed.classes.placeholder":
    "Классы через запятую, например: com.android.settings.homepage.SettingsHomepageActivity",
  "form.configuration.settings.mdm.restrictions": "Ограничения",
  "form.configuration.settings.mdm.restrictions.placeholder":
    "MDM ограничения, через запятую, например: no_sms,no_outgoing_calls,no_usb_file_transfer",
  "form.configuration.settings.mdm.launcher": "Особый URL лаунчера",
  "form.configuration.settings.mdm.launcher.placeholder":
    "Переопределить URL лаунчера для регистрации устройств в закрытых сетях",
  "form.configuration.settings.mdm.misc": "Другие записи QR-кода",
  "form.configuration.settings.mdm.misc.placeholder":
    'Записи, разделенные запятыми, например:\n"android.app.extra.PROVISIONING_LOCALE": "de_DE"',
  "form.configuration.settings.mdm.qrcode.url": "URL QR-кода",
  "form.configuration.settings.mdm.hint":
    "Выберите главное приложение и компонент",
  ...
  "form.configuration.apps.hint":
    'Совет: чтобы убрать приложения из этого списка, выберите действие "Блокировать" или "Не устанавливать".',
  "form.configuration.settings.design.use.default":
    "Использовать дизайн по умолчанию",
  "form.configuration.settings.design.color.background": "Цвет фона",
  "form.configuration.settings.design.color.background.placeholder":
    "Выберите цвет",
  "form.configuration.settings.design.color.app.names":
    "Цвет названий приложений",
  "form.configuration.settings.design.color.app.names.placeholder":
    "Выберите цвет",
  "form.configuration.settings.design.background.image.url":
    "URL фонового изображения",
  "form.configuration.settings.design.background.image.url.placeholder":
    "Введите url фонового изображения",
  ...
  "form.configuration.settings.design.desktop.header":
  ...
  "form.configuration.settings.design.desktop.header.hint":
    "Проверьте, что параметр отправляется на устройства (Настройки - Общие и языковые настройки)",
  "form.configuration.settings.design.desktop.header.template":
    "Введите шаблон",
  "form.configuration.settings.design.desktop.header.template.placeholder":
    "Используйте переменные",
  "form.configuration.settings.design.display.status":
    "Отображать время и статус батареи",
  "form.configuration.settings.design.upload": "Загрузить",
  "form.configuration.settings.common.name": "Название",
  "form.configuration.settings.common.name.placeholder":
    "Введите название конфигурации",
  "form.configuration.settings.common.desc": "Описание",
  "form.configuration.settings.common.desc.placeholder":
    "Введите описание конфигурации",
  "form.configuration.settings.common.admin.pwd": "Пароль разблокировки",
  "form.configuration.settings.common.admin.pwd.placeholder":
  ...
  "form.configuration.settings.common.timezone.mode":
  ...
  "form.configuration.settings.common.timezone.placeholder":
    "Например, Europe/Moscow",
  "form.configuration.settings.common.timezone.link": "Список временных зон",
  "form.configuration.settings.common.no.network.warning":
    "ВНИМАНИЕ! Не отключайте все каналы связи, это может привести к недоступности управления устройствами!",
  "form.configuration.settings.common.autostart.foreground":
    "Показывать приложения после автозапуска",
  "form.configuration.settings.request.updates": "Отслеживание местоположения",
  "form.configuration.settings.request.updates.donottrack":
    "Не активно (используются только данные сторонних приложений)",
  "form.configuration.settings.request.updates.gps": "Отслеживать по GPS",
  "form.configuration.settings.request.updates.wifi":
    "Отслеживать по Wi-Fi (должны быть включены сервисы Google)",
  "form.configuration.settings.request.updates.prompt.gps":
    "Для отслеживания местоположения по GPS необходимо включить GPS",
  "form.configuration.settings.request.updates.prompt.wifi":
    "Для отслеживания местоположения по Wi-Fi необходимо включить Wi-Fi",
  "form.configuration.settings.revoke.location.permission":
    "Не разрешать определять местоположение",
  "form.configuration.settings.revoke.location.permission.hint":
    "Если установлено, разрешение на определение местоположения не будет предоставлено агенту MDM, и он не сможет отслеживать местоположение устройства",
  "form.configuration.settings.apps.permissions":
    "Разрешения для других приложений",
  "form.configuration.settings.apps.permissions.grant":
    "Автоматическое предоставление всех разрешений",
  "form.configuration.settings.apps.permissions.ask.location":
    "Автоматически предоставлять все, запрашивать у пользователя разрешение на местоположение",
  "form.configuration.settings.apps.permissions.deny.location":
    "Автоматически предоставлять все, не предоставлять разрешение на местоположение",
  "form.configuration.settings.apps.permissions.ask.all":
    "Запросить у пользователя все разрешения",
  "form.configuration.settings.push.options": "Push-уведомления",
  "form.configuration.settings.push.options.mqtt.worker":
    "MQTT протокол (энергосбережение)",
  ...
  "form.configuration.settings.push.options.mqtt.worker.hint":
    "Доставляет Push-сообщения мгновенно, когда устройство активно. Но в спящем режиме сообщения могут задерживаться на несколько часов. Не используйте эту опцию на автономных устройствах. MQTT использует TCP-порт 31000, включите его на вашем брандмауэре.",
  "form.configuration.settings.push.options.mqtt.alarm.hint":
    "MQTT — это легкий протокол, потребляющий минимум ресурсов. MQTT использует порт TCP 31000, включите его в своем брандмауэре.",
  "form.configuration.settings.push.options.polling.hint":
    "Поддерживает постоянное HTTP-соединение, что может потреблять больше ресурсов сервера. Не требует никаких TCP-портов, кроме HTTP(S).",
  ...
  "form.configuration.settings.password.mode.present":
    "Пароль должен присутствовать",
  "form.configuration.settings.password.mode.easy":
    "Простой (6 символов или более)",
  "form.configuration.settings.password.mode.moderate":
    "Средний (8+ символов, буквы и цифры)",
  "form.configuration.settings.password.mode.strong":
    "Сложный (8+, разный регистр, цифры, знаки)",
  "form.configuration.settings.show.wifi":
    "Настройки Wi-Fi при ошибке подключения",
  "form.configuration.settings.use.default.launcher": "Фоновый режим",
  "form.configuration.settings.use.default.launcher.hint":
    "Не заменять системный лаунчер, а запускать только фоновые службы MDM. Не рекомендуется в режиме киоска.",
  ...
  "form.configuration.settings.files.default.path":
    "Путь по умолчанию на устройстве",
  ...
  "form.configuration.files.variables.hint":
    "Строки DEVICE_NUMBER, IMEI, CUSTOM* будут заменены их значениями",
  ...
  "form.configuration.file.description.placeholder":
    "Опционально, для вашего удобства",
  "form.configuration.file.path": "Путь на устройстве",
  "form.configuration.file.path.placeholder":
    "Без пути к носителю, например /my-app/image.jpg",
  "form.configuration.file.url": "URL",
  "form.configuration.file.url.placeholder":
    "Только если файл на внешнем ресурсе",
  ...
  "form.configuration.file.remove.prompt.1":
    "Этот файл больше не будет синхронизироваться с устройствами",
  ...
  "form.password.label.password.confirm.placeholder":
  ...
  "form.application.url.hint":
    "Используйте file:///storage/emulated/0/... для создания ссылок на локальные файлы и папки",
  "form.application.pkg": "ID пакета",
  "form.application.from.file": "определяется из файла",
  "form.application.pkg.title":
    "ID пакета определяется автоматически при загрузке файла. Указывайте ID пакета вручную только для системных приложений.",
  "form.application.pkg.placeholder": "Например, com.android.camera",
  "form.application.disabled.arch": "Зависит от версии",
  "form.application.disabled.arch.title":
    "Чтобы добавить APK для разных архитектур CPU, нажмите «Добавить» или откройте список версий приложения.",
  "form.application.arch": "Нативный код",
  "form.application.arch.title":
    "Некоторые приложения содержат код, оптимизированный для определенной архитектуры CPU. В этом случае вам надо загрузить два APK (для архитектур armeabi-v7a и arm64-v8a)",
  ...
  "form.application.arch.warning":
    'Этот APK оптимизирован только для ${arch} и может работать не на всех устройствах. Рекомендуем загрузить еще один APK для другой архитектуры CPU. Для использования APK на всех устройствах, выберите "Универсальный APK".',
  "form.application.arch.success":
    "Это приложение содержит APK-файлы для обеих архитектур CPU.",
  ...
  "form.application.name.title":
    "Под этим названием вы будете видеть приложение в списке. Рекомендуем давать приложениям уникальные и информативные названия.",
  "form.application.name.placeholder": "Например, Камера (Android)",
  "form.application.version": "Версия",
  "form.application.version.title":
    "Версия пакета определяется автоматически при загрузке файла. Для системных приложений ставьте 0.",
  "form.application.version.code": "Код версии",
  "form.application.version.code.exists":
    "Версия с таким кодом уже существует. Пожалуйста, сообщите об этой проблеме разработчикам приложения.",
  "form.application.version.placeholder": "0 для системных приложений",
  "form.application.system": "Системное",
  "form.application.system.title":
    "Системные приложения уже установлены на устройстве и не требуют файла. Ставьте этот флажок, только если требуется разрешить системный пакет.",
  "form.application.run.after.install": "Запуск после установки",
  "form.application.run.after.install.title":
    "Приложения с фоновыми сервисами требуют явного запуска хотя бы один раз.",
  "form.application.run.at.boot": "Запуск при загрузке",
  "form.application.run.at.boot.title":
    "Этот флажок будет открывать окно приложения при каждом запуске. Он не влияет на запуск фоновых сервисов приложений.",
  "form.application.url": "URL",
  "form.application.url.title":
    "URL нужно указывать, только если приложение размещено на внешнем ресурсе. Лучше загрузите APK файл на сервер с помощью поля ниже.",
  "form.application.url.disabled":
    'URL редактируется для каждой версии в отдельности. Чтобы изменить URL, закройте это окно и нажмите иконку "Версии".',
  "form.application.file": "Файл",
  "form.application.auto.update": "Обновить автоматически",
  "form.application.auto.update.title":
    "Установите этот флаг, чтобы обновить все конфигурации, в которых установлено приложение. Используйте, только если вы на 100% уверены, что приложение работает стабильно.",
  "form.application.showLabel": "Показать ярлык",
  "form.application.showLabel.title":
    "Показывать ли иконку приложения в лаунчере. Эту опцию можно затем переопределить в конфигурации.",
  "form.application.use.kiosk": "Открыть в Киоск-Браузере",
  "form.application.use.kiosk.title":
    "Установите этот флаг, если нужно открыть страницу в Киоск-Браузере без возможности изменения адреса",
  ...
  "form.configuration.copy.new.name.placeholder":
  ...
  "form.customer.language.placeholder":
    "Оставьте пустым для английского, или две строчные буквы",
  ...
  "form.device.number.locked":
    "Нельзя изменить номер, если устройство в процессе миграции.",
  "form.device.migration.warning":
    "Устройство будет переключено на новый номер. Проверьте, что устройство включено - номер изменится, если устройство в сети.",
  ...
  "form.file.external.title":
    "Вместо загрузки файла вы можете указать URL на внешнем ресурсе",
  ...
  "form.file.path.placeholder":
    'Введите относительный путь, например "/files/"',
  ...
  "form.settings.common.visible.columns":
    'Видимые столбцы в таблице "Устройства"',
  ...
  "form.settings.design.url.background.image.placeholder":
    "Введите URL фонового изображения",
  ...
  "form.settings.misc.custom.property.name.placeholder":
    "Введите название пользовательского поля",
  "form.settings.misc.create.new.devices":
    "Добавлять устр-во при первом обращении",
  ...
  "form.settings.misc.password.alphanumeric":
    "Строчные и прописные буквы, цифры",
  "form.settings.misc.password.specialchar":
    "Строчные и прописные буквы, цифры, специальные символы",
  ...
  "idle.logout.message":
    "Вы выйдете из системы через ${sec} секунд из-за неактивности",
  ...
  "form.qr.number.hint":
    "Очистите номер устройства, чтобы включить автоматическое присвоение номера устройства",
  ...
  "form.password.reset.invalid":
    "К сожалению, эта ссылка для сброса пароля недействительна",
  "form.password.reset.submit": "Установить пароль",

  "form.two.factor.auth.title": "Двухфакторная аутентификация",
  "form.two.factor.auth.hint":
    "Чтобы завершить регистрацию, установите приложение Authenticator на свое мобильное устройство, отсканируйте QR-код, сгенерируйте и введите проверочный код.",
  "form.two.factor.auth.code.invalid": "Код проверки недействителен!",
  "form.two.factor.auth.code": "Код проверки",
  "form.two.factor.auth.code.hint":
    "6-значный код из приложения для аутентификации",
  "form.two.factor.auth.code.error":
    "Код должен представлять собой 6-значное число",
  "form.two.factor.auth.verify": "Проверить",
  "form.two.factor.auth.settings.hint":
    "Чтобы настроить двухфакторную аутентификацию, установите приложение Authenticator на свое мобильное устройство, отсканируйте QR-код, сгенерируйте и введите проверочный код.",
  ...
  "form.two.factor.auth.off.confirm":
    "Вы хотите отключить двухфакторную аутентификацию? После повторного включения все аутентификаторы станут недействительными.",
  ...
  "table.heading.file.remove.hint":
    "Принудительно удалить файл из хранилища устройства",
  ...
  "app.description":
    "- система управления мобильными устройствами с открытым кодом",
  "app.title": "${appName} - панель управления",

  "box.show.my.apps.only": "Показать только мои приложения",
  "configuration.app.version.upgrade.message":
    "Установлена версия ${installedVersion}, доступна версия ${latestVersion}",
  ...
  "common.app.clarification":
    "Это приложение является общедоступным, его редактирование запрещено. Для добавления другой версии, пожалуйста, обратитесь к администратору.",

  "qrcode.help.line1":
    "Чтобы настроить Android-устройство (версии Android 7 или выше) в управляемом (корпоративном) режиме:",
  "qrcode.help.line2": "Выполните сброс к заводским настройкам",
  "qrcode.help.line3":
    "Нажмите 7 раз подряд на любом месте стартового экрана (должен появиться скрытый режим сканирования QR-кода)",
  "qrcode.help.line4":
    "Следуйте инструкциям устройства: примите условия использования, подключитесь к Wi-Fi, отсканируйте QR-код",
  "qrcode.help.line5":
    'Код может содержать также ID устройства в системе ${appName} (после настройки его не нужно будет вводить). Для включения ID устройства в QR код, введите его на этом экране и нажмите "Обновить".',

  "form.configuration.app.version.select.select.title":
    "Выберите версию для установки",
  "form.configuration.app.version.select.version.check.off":
    "Отключить проверку версии",
  "form.configuration.app.version.select.upgrade.warning":
    'Обновить приложение "${v1}" до версии "${v3}" для конфигурации "${v2}"?',
  "form.configuration.app.version.select.downgrade.warning":
    ' Понижение версии УДАЛИТ ВСЕ ДАННЫЕ ПРИЛОЖЕНИЯ на всех устройствах! Понизить версию приложения "${v1}" до версии "${v2}"?',

  "hint.step.1": "Чтобы начать настройку устройства, нажмите сюда",
  "hint.step.2": "Чтобы показать QR код, нажмите сюда",
  "hint.step.3":
    "Чтобы узнать, как открыть сканер QR кода на устройстве, нажмите здесь",
  "hint.step.4":
    'Найдите доступный ID во вкладке "устройства". Нажмите "Обновить", чтобы включить его в QR код.',

  "ie.browser.notice.1":
    "К сожалению, браузер Internet Explorer не поддерживается.",
  "ie.browser.notice.2":
    'Рекомендуемый браузер для использования ${appName} - <a href="https://support.google.com/chrome/answer/95346?co=GENIE.Platform%3DDesktop">Chrome</a>.',

  "form.resolved.duplicate.pkg.text1":
    'ID пакета "${pkg}" уже используется приложениями, указанными ниже.',
  "form.resolved.duplicate.pkg.text2":
    "Вы хотите добавить новое приложение или новую версию существующего приложения?",
  "form.resolved.duplicate.pkg.text3": "Новая версия для",
  "form.resolved.duplicate.pkg.text4":
    'Package ID "${pkg}" уже используется приложениями ${apps}',
  "form.resolved.duplicate.pkg.text5":
    "Вы уверены, что хотите изменить package ID?",
  ...
  "account.expiring":
    "Ваша учетная запись истекает в течение ${days} дней. Пожалуйста, свяжитесь с продавцом для продления.",
  "account.expired":
    "Ваша учетная запись истекла. Пожалуйста, свяжитесь с продавцом для продления.",
  "account.expired.short": "Ваша учетная запись истекла!",
  "device.limit.achieved":
    "Нельзя добавить устройство - вы достигли лимита. Удалите устройства или свяжитесь с продавцом для увеличения лимита.",
  ...
  "updates.auto.update":
    "Автоматически обновлять мобильные приложения (используйте с осторожностью в рабочей среде!)",
  "updates.enable.stats":
    "Отправить статистику использования поставщику услуг для повышения производительности системы",
  ...
  "updates.web.hint":
    "Чтобы завершить обновление веб-приложения, запустите сценарий оболочки /opt/hmdm/update-web-app.sh в консоли SSH",

  "permission.edit_device_app_settings":
    "Управление настройками приложения для устройств",
  "permission.plugins_customer_access_management":
    "Управление доступными плагинами",
