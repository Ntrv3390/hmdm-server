...
document.localization["en_US"] = {
  ...
  "signup.email.check":
    "Please check your email and follow the link to complete the registration!",
  ...
  "signup.customer.id.invalid":
    "Please use 6 or more characters, letters and digits only",
  ...
  "signup.finalized.description":
    "In a short time, you must get the email containing useful instructions. Please review this email and login to the web panel using your username and password.",
  "signup.token.invalid.title": "The token is invalid or already used",
  "signup.token.invalid.description":
    "Please retry signing up to create a new account!",
  ...
  "devices.permissions.not.as.device.admin":
    "- The application is not installed as a device administrator",
  "devices.permissions.window.overlap.prohibited":
    "- Overlay on top of other windows is not available",
  "devices.permissions.history.access.prohibited":
    "- Access to usage history is not configured",
  ...
  "devices.app.installed.and.version.available":
    "- ${applicationName}: installed ${applicationInstalledVersion}, available ${applicationVersionAvailable}",
  ...
  "devices.settings.conformance.broken":
    "Mismatch with settings: (${serverData})",
  ...
  "question.impersonate.user":
    'Log in to the application as the administrator of the organization "${customerName}"?',
  "question.change.user":
    'Log in to the application as the user "${userName}"?',
  ...
  "question.delete.application.version":
    'Delete version "${applicationVersion}"?',
  ...
  "question.delete.device":
    'Delete the device with the number "${deviceNumber}"?',
  "question.exit.without.saving":
    "Changes are not saved. Anyway leave this page?",
  "question.turn2common.application":
    'Share the application "${applicationName}"?',
  "question.app.upgrade":
    'Update application "${v1}" to latest version for configuration "${v2}"?',
  ...
  "error.application.version.pkg.mismatch":
    "Package ID of the file (${actual}) does not correspond to the application (${expected})",
  ...
  "error.invalid.configuration.mainApp":
    "In the MDM settings, the wrong main application is used",
  "error.invalid.configuration.contentApp":
    "Invalid content application used in MDM settings",
  ...
  "error.duplicate.customer.name":
    "The organization with the entered name already exists. Try a different name.",
  "error.duplicate.group.name":
    "The group with the entered name already exists. Try a different name.",
  "error.duplicate.configuration.name":
    "The configuration with the entered name already exists. Try a different name.",
  ...
  "error.configuration.device.use":
    'Cannot delete this configuration, it is used on devices. First go to "Devices", find the devices using this configuration and change their settings.',
  ...
  "error.duplicate.application":
    "An application with this package ID and version already exists",
  "error.recent.application.version.exists":
    "More recent application version exists",
  "error.common.application.access.prohibited":
    "Managing of the common applications is allowed by Super-Administrator only",
  "error.application.config.reference.exists":
    "The application is used in configurations and cannot be deleted",
  "error.application.version.deletion.prohibited":
    "The version is either unique or used in configurations and cannot be deleted",
  ...
  "error.notempty.group":
    "This group includes one or more devices. You cannot remove it.",
  ...
  "error.app.name.exists":
    "Another application with this name already exists. Please specify a unique name.",
  ...
  "success.file.uploaded.need.save":
    'File uploaded successfully. Enter the relative path and click "Save".',
  ...
  "success.config.update.notification":
    "Configuration update command has been sent to devices",
  "success.config.update.device.app.settings.notification":
    "The command to update application settings has been sent to the device.",
  ...
  "configuration.add.warning":
    "Are you sure you want to create an empty configuration? You will need to add all required system apps manually. Consider copying and modifying an existing configuration instead.",
  "configuration.remove.warning":
    "Are you sure you want to remove the last configuration? You will lose information which system apps are required.",
  ...
  "form.configuration.settings.download.updates.limited":
    "3 attempts in the mobile network",
  ...
  "form.configuration.settings.block.status.bar.hint":
    "This setting is deprecated and works well on Android 6 and below. To lock the status bar on newer Android versions, use the kiosk mode (MDM settings).",
  ...
  "form.configuration.settings.mdm.component.event.receiver.placeholder":
    "Should be com.hmdm.launcher.AdminReceiver",
  ...
  "form.configuration.settings.mdm.component.wifi.ssid.placeholder":
    "Enrollment WiFi SSID - leave empty to enter manually",
  ...
  "form.configuration.settings.mdm.component.wifi.password.placeholder":
    "Enrollment WiFi pass - leave empty to enter manually",
  "form.configuration.settings.mdm.component.wifi.security":
    "WiFi security type",
  "form.configuration.settings.mdm.component.wifi.notice":
    "Notice: these WiFi settings are applied to the initial enrollment only!",
  ...
  "form.configuration.settings.mdm.component.server.url.placeholder":
    "Used for migration to a new MDM server",
  ...
  "form.configuration.settings.mdm.lock.safe.settings":
    "Lock safe settings (WiFi, GPS, etc)",
  ...
  "form.configuration.settings.mdm.hint":
    "Select the main application and component",
  ...
  "form.configuration.apps.hint":
    'Hint: to unlink the app from the configuration, select the action "Block" or "Do not install".',
  ...
  "form.configuration.settings.design.desktop.header.description":
    "Description",
  ...
  "form.configuration.settings.design.desktop.header.hint":
    "Make sure this parameter is sent to devices (Settings - General and language settings)",
  ...
  "form.configuration.settings.design.display.status":
    "Display time and battery state",
  ...
  "form.configuration.settings.common.admin.pwd.placeholder":
    "Enter the device unlock password",
  ...
  "form.configuration.settings.apps.permissions.ask.location":
    "Auto-grant all, ask user for the location permission",
  "form.configuration.settings.apps.permissions.deny.location":
    "Auto-grant all, do not grant the location permission",
  ...
  "form.configuration.settings.push.options.mqtt.worker.hint":
    "Delivers Push messages instantly when the device is active. But messages may delay by up to few hours in sleeping mode. Do not use this option on standalone devices. MQTT uses TCP port 31000, enable it on your firewall.",
  "form.configuration.settings.push.options.mqtt.alarm.hint":
    "MQTT is a lightweight protocol consuming minimal resources. MQTT uses TCP port 31000, enable it on your firewall.",
  "form.configuration.settings.push.options.polling.hint":
    "Long polling persists an HTTP connection which can consume more server resources. Doesn't require any TCP ports other than HTTP(S).",
  ...
  "form.configuration.settings.password.mode.moderate":
    "Moderate (8+ symbols, letters and digits)",
  "form.configuration.settings.password.mode.strong":
    "Strong (8+, upper & lowercase, digits, signs)",
  ...
  "form.configuration.settings.use.default.launcher.hint":
    "Do not replace a system launcher, only run background MDM services. Not recommended with the kiosk mode.",
  ...
  "form.configuration.files.variables.hint":
    "Strings DEVICE_NUMBER, IMEI, CUSTOM* will be replaced by their values",
  ...
  "form.configuration.file.path.placeholder":
    "Excluding path to a drive, e.g. /my-app/image.jpg",
  "form.configuration.file.url": "URL",
  "form.configuration.file.url.placeholder":
    "If only a file is hosted on an external resource",
  ...
  "form.configuration.file.remove.prompt.1":
    "This file will not be synchronized with devices any more",
  ...
  "form.application.url.hint":
    "Use file:///storage/emulated/0/... to create links to local files and folders",
  "form.application.pkg": "Package ID",
  "form.application.from.file": "determined from file",
  "form.application.pkg.title":
    "Package ID is automatically determined when you upload the APK file. Manually entered package ID is required for system apps only.",
  ...
  "form.application.disabled.arch.title":
    'To add APKs for different CPU architectures, click "Add", or open the app versions list',
  "form.application.arch": "Native code",
  "form.application.arch.title":
    "Some apps contain code optimized for certain CPU architecture. In this case, you need to upload two APKs (for armeabi-v7a and arm64-v8a architectures)",
  ...
  "form.application.arch.warning":
    'This APK is optimized for ${arch} only and may not work on all devices. It\'s recommended to upload another APK optimized for another CPU arch. To use this APK on all devices, select "Universal APK".',
  "form.application.arch.success":
    "This app contains APKs for both CPU architectures",
  ...
  "form.application.name.title":
    "You will see the app name in the list. We recommend to use unique and informative names.",
  ...
  "form.application.version.title":
    "Package version is automatically determined when you upload the APK file. Set it to 0 for system apps.",
  "form.application.version.code": "Version Code",
  "form.application.version.code.exists":
    "A version with the same code already exists. Please report this issue to the app developers.",
  "form.application.system": "Preinstalled app",
  "form.application.system.title":
    "System applications are preinstalled on a device and do not require URL or file. Set this flag only if you need to enable a certain system package.",
  "form.application.run.after.install": "Run after installation",
  "form.application.run.after.install.title":
    "Applications with background services need to be started in the foreground at least once.",
  "form.application.run.at.boot": "Run at boot",
  "form.application.run.at.boot.title":
    "Set this flag if you need to run the app in the foreground after boot. This flag is not affecting background processes.",
  "form.application.url": "URL",
  "form.application.url.title":
    "The URL should be typed in only if your app is hosted on an external resource. It is recommended to upload an APK file by using a field below.",
  "form.application.url.disabled":
    'URL is set up for each version. To change the URL, close this window and click the "Versions" icon.',
  "form.application.file": "File",
  "form.application.auto.update": "Auto Update",
  "form.application.auto.update.title":
    "Set this flag to update all configurations where the app is installed. Use only if you are 100% sure the app is stable.",
  "form.application.showLabel": "Show Icon",
  "form.application.showLabel.title":
    "This flag denotes whether the app icon should be displayed in the launcher. This option may be overridden in the configuration.",
  "form.application.use.kiosk": "Open in Kiosk Browser",
  "form.application.use.kiosk.title":
    "Set this flag if you'd like to open a web page in Kiosk Browser without any possibility to change the address",
  ...
  "form.configuration.copy.new.name.placeholder":
    "Enter the new configuration name",

  "form.customer.name": "Customer ID",
  "form.customer.name.placeholder":
    "Organization identifier used for signing in",
  ...
  "form.customer.language.placeholder":
    "Empty for English or two small letters",
  ...
  "form.device.number.locked":
    "Cannot change the number because the previous number change was not completed.",
  "form.device.migration.warning":
    "The device number will be changed. Make sure the device is switched on and online.",
  ...
  "form.file.external.title":
    "Instead of uploading the file, you can specify the URL on an external resource",
  ...
  "form.settings.common.visible.columns":
    'Visible columns in the "Devices" table',
  ...
  "form.settings.misc.custom.property.name.placeholder":
    "Enter name for a custom property",
  ...
  "form.settings.misc.password.alphanumeric":
    "Lower and uppercase letters, digits",
  "form.settings.misc.password.specialchar":
    "Lower and uppercase letters, digits, special chars",
  ...
  "idle.logout.message":
    "You will be signed out in ${sec} seconds because of inactivity",
  ...
  "form.qr.number.hint":
    "Clear the device number to enable automatic device number assignment",
  ...
  "form.two.factor.auth.hint":
    "To complete your sign-up, please install the Authenticator app on your mobile device, scan the QR code, generate and enter the verification code.",
  ...
  "form.two.factor.auth.settings.hint":
    "To set the two-factor authentication, please install the Authenticator app on your mobile device, scan the QR code, generate and enter the verification code.",
  ...
  "form.two.factor.auth.off.confirm":
    "Do you want to turn off two-factor authentication? After turning it back on, all authenticators will become invalid.",
  ...
  "table.heading.file.remove.hint":
    "Forces the file removal from the device storage",
  ...
  "app.vendor.name": "Brother Pharmach MDM",
  "app.vendor.link": "",
  ...
  "configuration.app.version.upgrade.message":
    "Installed version ${installedVersion}, available version ${latestVersion}",
  ...
  "common.app.clarification":
    "This application is public and not available for editing. To add another version of this app, please contact the administrator.",

  "qrcode.help.line1":
    "To setup the Android device (version 7 or higher) in a managed (corporate) mode:",
  "qrcode.help.line2": "Reset the device to factory settings",
  "qrcode.help.line3":
    "Tap 7 times on any place of the start screen (you must enter a hidden QR code scanning mode)",
  "qrcode.help.line4":
    "Follow the device instructions: accept the terms, connect to Wi-Fi, scan this QR-code",
  "qrcode.help.line5":
    'The QR code may contain the device ID for ${appName} (so you don\'t need to enter it on a mobile device). To embed the device ID into the QR code, enter the device ID on this screen and click "Renew".',
  ...
  "form.configuration.app.version.select.upgrade.warning":
    'Upgrade application "${v1}" to version "${v3}" for configuration "${v2}"?',
  "form.configuration.app.version.select.downgrade.warning":
    'Downgrade version DELETE ALL THESE APPLICATIONS on all devices! Downgrade the application version "${v1}" to version "${v2}"? ',

  "hint.step.1": "Click here to start the device enrollment",
  "hint.step.2": "Click here to open the QR code",
  "hint.step.3":
    "Click here to see how to open the QR code scanner on the device",
  "hint.step.4":
    "Find an available device ID in the «Devices» tab. Click «Renew» to include it in the QR code.",

  "ie.browser.notice.1": "Unfortunately, Internet Explorer is not supported.",
  "ie.browser.notice.2":
    'Recommended browser for using ${appName} - <a href="https://support.google.com/chrome/answer/95346?co=GENIE.Platform%3DDesktop">Chrome</a>.',

  "form.resolved.duplicate.pkg.text1":
    'Package ID "${pkg}" is already used by the applications listed below.',
  "form.resolved.duplicate.pkg.text2":
    "Do you want to add a new application or a new version of an existing application?",
  "form.resolved.duplicate.pkg.text3": "New version for",
  "form.resolved.duplicate.pkg.text4":
    'Package ID "${pkg}" is already used by applications ${apps}',
  "form.resolved.duplicate.pkg.text5":
    "Are you sure you want to change the package ID?",
  ...
  "account.expiring":
    "Your account will be expired in ${days} days. Please contact the seller to renew your account.",
  "account.expired.short": "Your account has expired!",
  "account.expired":
    "Your account has expired. Please contact the seller to renew your account.",
  "device.limit.achieved":
    "Cannot add a device because you have reached your limit. Please remove some devices or contact the seller to extend your device limit.",
  ...
  "updates.auto.update":
    "Automatically update mobile apps (use with care in production!)",
  "updates.enable.stats":
    "Send usage statistics to the service provider to improve system performance",
  "updates.get": "Get updates",
  "updates.checking": "Checking for updates...",
  "updates.getting": "Getting updates...",
  "updates.success": "Update completed",
  "updates.web.hint":
    'To complete the web app update, run the shell script "/opt/hmdm/update-web-app.sh" in the SSH console',
